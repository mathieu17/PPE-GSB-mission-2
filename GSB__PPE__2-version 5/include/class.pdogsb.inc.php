 ...
 */
     ...
     * @param $mois
     */
    public function validerUneFiche($visiteur_id, $mois){
    ...
    /**
     * Récupère un tableau de mois avec les fiches validees 
     * @return array
     */
    public function FichesValidees(){
    ...
    /**
     * Mise en paiement d'une fiche validée
     * @param $idVisiteur
     * @param $mois
     */
